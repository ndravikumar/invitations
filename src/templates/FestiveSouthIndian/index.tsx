...
import { KolamPattern, MangoLeafBorder } from "@/components/wedding/DecorativeSvgs";
...
const FestiveSouthIndian = ({ data }: TemplateProps) => {
  ...
  return (
    <div className="min-h-screen bg-[#fff4dd] text-[#5f1316]">
      <InviteControls title="Festive South Indian Wedding" />
      <Link
        to="/templates"
      ...
      >
        <motion.div
          ...
          className="grid w-full max-w-4xl gap-4 rounded-[2rem] border border-white/15 bg-white/10 p-6 text-white backdrop-blur md:grid-cols-3"
        >
          {[
      ...
      <section className="relative px-4 py-16 sm:px-6">
        ...
        <div className="mx-auto max-w-6xl rounded-[2rem] border border-[#c99d2b]/20 bg-white/70 p-8 shadow-lg">
