...
const DevVSCode = ({ data }: TemplateProps) => {
        ...
        <div id="invitation-start" className="mx-auto flex min-h-screen max-w-7xl flex-col gap-6 px-4 py-20 sm:px-6">
          ...
          >
              ...
              <div className="space-y-2">
                {sidebarFiles.map((file, index) => (
                  <motion.div
                    ...
                    className={`flex items-center gap-3 rounded-2xl border px-4 py-3 text-sm ${index === 0 ? "border-cyan-400/30 bg-cyan-400/10 text-cyan-300" : isDark ? "border-white/5 bg-white/[0.03]" : "border-slate-200 bg-white/60"}`}
                  >
                    <Files size={16} />
                    {file}
                  </motion.div>
            ...
            <main className="space-y-8 p-4 sm:p-6 lg:p-8">
              <div className={`rounded-[1.6rem] border ${panelClasses}`}>
              ...
              <div className="grid gap-6 xl:grid-cols-[1.3fr_0.7fr]">
                ...
                <div className={`rounded-[1.5rem] border p-5 ${panelClasses}`}>
                  ...
                  <WeddingCountdown
                    ...
                    className="mt-6"
                    itemClassName={isDark ? "border-white/10 bg-[#020817] text-white" : "border-slate-200 bg-white text-slate-900"}
                  />
                </div>
              </div>
